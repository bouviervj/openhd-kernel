...
#include "../vscommon/rtp/rtpreceiver.h"
...
#include "../vscommon/custom/rawreceiver.h"
...
private:
    ...
    int open_and_decode_until_error(const OpenHDVideoHelper::VideoStreamConfig settings);
...
private:
    ...
    std::unique_ptr<Timer> timer_check_settings_changed = nullptr;
    void timer_check_settings_changed_callback();
    OpenHDVideoHelper::VideoStreamConfig m_last_video_settings;
private:
...
private:
    ...
    void open_and_decode_until_error_custom_rtp(const OpenHDVideoHelper::VideoStreamConfig settings);
...
private:
    ...
    void dirty_generic_decode_via_external_decode_service(const OpenHDVideoHelper::VideoStreamConfig& settings);
};
