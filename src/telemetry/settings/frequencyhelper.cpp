...
std::vector<int> FrequencyHelper::get_frequencies(int filter)
{
    std::vector<int> ret;
    if(filter==0){
...
std::vector<int> FrequencyHelper::filter_frequencies_40mhz_ht40plus_only(const std::vector<int>& frequencies)
{
...
std::vector<int> FrequencyHelper::get_frequencies_all_40Mhz()
{
    std::vector<int> ret;
    const auto frequency_items=openhd::get_all_channels_2G_5G();
    for(auto& item:frequency_items){
...
std::string FrequencyHelper::get_frequency_description(int frequency_mhz)
{
    const auto frequency_item=openhd::channel_from_frequency(frequency_mhz);
    std::stringstream ss;
...
std::vector<int> FrequencyHelper::filter_frequencies(const std::vector<int>& frequencies, int filter_level)
{
    std::vector<int> ret;
