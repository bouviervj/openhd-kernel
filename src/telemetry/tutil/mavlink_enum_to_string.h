...
static std::string sub_mode_from_enum(SUB_MODE mode){
    switch (mode) {
...
static std::string rover_mode_from_enum(ROVER_MODE mode){
    switch (mode) {
...
static std::string copter_mode_from_enum(COPTER_MODE mode){
    switch (mode) {
...
static std::string plane_mode_from_enum(PLANE_MODE mode){
    switch (mode) {
...
static std::string tracker_mode_from_enum(TRACKER_MODE mode){
    switch (mode) {
...
static std::string mav_type_to_string(MAV_TYPE type){
    switch(type){
...
struct MavTypeAndFlightMode{
    std::string mav_type="Unknown"; // Copter, plane, rocket, whatever, specific, e.g. it says Hexacopter if the uav is a hexa (not copter)
    std::string flight_mode="Unknown"; // Flight mode for this uav
