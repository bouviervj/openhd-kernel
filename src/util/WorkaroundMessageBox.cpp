...
WorkaroundMessageBox::WorkaroundMessageBox(){
...
void WorkaroundMessageBox::do_not_call_me_set_text_and_show(std::string text,int optional_time_until_autoremove)
{
